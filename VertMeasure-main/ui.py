...
def pil_to_qimage(pil_image):
    ...
    bytes_per_line = rgb_image.mode == "RGB" and 3 or 4
    qimage = QImage(rgb_image.tobytes(), width, height, bytes_per_line * width, 
                   QImage.Format_RGB888 if rgb_image.mode == "RGB" else QImage.Format_RGBA8888)
    return qimage
...
class Window(QWidget):
    def __init__(self, screen_width, screen_height):
        ...
        self.setFixedSize(int(self.windowWidth), int(self.windowHeight))
    ...
    def calibration_page_generator(self, ref_style=0):
        ...
        self.__calibration_qImg = pil_to_qimage(frame_img)
    ...
    def update_demo_display(self):
        ...
        self.__demo_qImg = pil_to_qimage(frame_img)
